...
`;function fe(s){const{allnames:l}=s,[n,t]=o.exports.useState(""),{data:e,isError:d,isLoading:f}=U("all-names",()=>Q(l)),u=e==null?void 0:e.result,i=(e==null?void 0:e.message)||e;return o.exports.useEffect(()=>{W(i,t)},[i]),c(M,{children:c(R,{p:"1em",children:a(V,{children:[c(J,{m:"0.5em 0",color:"#009966",upper:!0,children:"B\xFAsqueda por nombre."}),c(re,{data:u}),a(ae,{children:[d&&c("div",{children:"An error ocurred..."}),f&&a("div",{children:[c(G,{size:"sm",color:"white"}),c(q,{color:"white",children:"Loading..."})]}),n&&c(X,{message:n})]})]})})})}const ae=y.div`
  width: 100%;
